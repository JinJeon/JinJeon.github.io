...
|      | ARRAY                                | LINKED LIST                   |
| ---- | ------------------------------------ | ----------------------------- |
| 장점 | 랜덤 엑세스가 빠르다.                | 동적 메모리 사용 가능         |
|      |                                      | 메모리 사용이 효율적          |
|      |                                      | 대용량 데이터 처리에 적합     |
| 단점 | 메모리 사용이 비효율적               | 특정 위치 데이터 검색 시 느림 |
|      | 배열 내 데이터 이동 및 재구성 어려움 | 메모리 추가 사용이 필요       |

## 2. 노드

<img src="/image/22_01/10/자료구조 5.png" alt="drawing" width="100%">
...
<img src="/image/22_01/10/자료구조 6.png" alt="drawing" width="100%">
...
<img src="/image/22_01/10/자료구조 7.png" alt="drawing" width="100%">
### 3-2. 삽입
...
- 앞에 삽입하는 경우  
  ...
  **’새로운 노드의 NEXT → 현재 HEAD의 NEXT’  
  ...
  <img src="/image/22_01/10/자료구조 8.png" alt="drawing" width="100%">
- 뒤에 삽입하는 경우  
  ...
  **’새로운 노드의 NEXT → NULL’,  
  ...
  <img src="/image/22_01/10/자료구조 9.png" alt="drawing" width="100%">
- 원하는 위치에 삽입하는 경우  
  ...
  **’LOCATION의 NEXT → FIRST의 DATA’,  
  ...
  의 형태로 이루어진다.
  <img src="/image/22_01/10/자료구조 10.png" alt="drawing" width="100%">
...
<img src="/image/22_01/10/자료구조 11.png" alt="drawing" width="100%">
